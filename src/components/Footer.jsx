    ...
    <footer className="bg-blue-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 mb-8">
          {/* Left Column */}
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-4" style={{ fontFamily: 'cursive' }}>
              VMSS TECHNOLOGIES
            </h2>
            <p className="text-blue-200 mb-6 text-sm sm:text-base">
              Empowering professionals with skills for the future through expert-led training programs and practical learning solutions.
            </p>
            <div className="flex space-x-3">
              <a href="#" className="bg-blue-800 w-10 h-10 flex items-center justify-center rounded hover:bg-blue-700 transition-colors">
